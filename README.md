...
More inportantly this is an `ARM64` build ontop of alpine -> ready to run on your raspberry pi with ubuntu and it's as small as possible.
...
* support for __7Zip archives__
* support for the latest `par2` repair utility build for alpine and ARM64
...
* versions get rebuild weekly to include any updates to Alpine
